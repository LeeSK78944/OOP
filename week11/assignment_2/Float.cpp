...
Number *Float::sub(Number * num) {
	...
	if (num->types() == INTEGER) {
         ...
         Complex *nC = dynamic_cast<Complex *>(num);
         nC->set_val(this->value-nC->real(), 0-nC->imag());
         delete(this);
         return nC;
     } else {
         //empty
...
Number *Float::mul(Number *num) {
	...
	if (num->types() == INTEGER) {
         ...
         Complex *nC = dynamic_cast<Complex *>(num);
         nC->set_val(this->value*nC->real(), this->value*nC->imag());
         delete(this);
         return nC;
     } else {
         //empty
